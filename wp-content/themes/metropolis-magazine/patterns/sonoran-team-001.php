<?php
/**
 * Title: Metropolis Magazine Team 1
 * Slug: metropolis-magazine/sonoran-team-001
 * Categories: teams
 */
?>
...
<p class="has-text-align-center has-secondary-color has-text-color has-superbfont-small-font-size">Get to know the talented indivisuals behind our written guides of New York.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-small-font-size">Sophie Turner</h3>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-secondary-color has-text-color has-superbfont-xsmall-font-size"> A passionate urban explorer, travel aficionado, and food connoisseur. With her "City Whisperer" perspective, she shares valuable insights and personal experiences.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":3,"textColor":"contrast","fontSize":"superbfont-small"} -->
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-small-font-size">Lily Harper</h3>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"contrast","fontSize":"superbfont-xsmall"} -->
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-xsmall-font-size" style="font-style:normal;font-weight:400">The Cultural Curator</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"center","textColor":"secondary","fontSize":"superbfont-xsmall"} -->
<p class="has-text-align-center has-secondary-color has-text-color has-superbfont-xsmall-font-size">Lily’s guides offer readers a window into the cultural riches of various cities, from art galleries and live performances to local music scenes. She brings the artistic and creative aspects.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":3,"textColor":"contrast","fontSize":"superbfont-small"} -->
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-small-font-size">Olivia Mercer</h3>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"contrast","fontSize":"superbfont-xsmall"} -->
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-xsmall-font-size" style="font-style:normal;font-weight:400">The Travel Advocate</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"center","textColor":"secondary","fontSize":"superbfont-xsmall"} -->
<p class="has-text-align-center has-secondary-color has-text-color has-superbfont-xsmall-font-size">Olivia is a passionate environmentalist and sustainability advocate. Her guides focus on eco-friendly travel, responsible tourism, and sustainable city living.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":3,"textColor":"contrast","fontSize":"superbfont-small"} -->
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-small-font-size">Ella Stone</h3>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"contrast","fontSize":"superbfont-xsmall"} -->
<h3 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-xsmall-font-size" style="font-style:normal;font-weight:400">Co-Founder</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"center","textColor":"secondary","fontSize":"superbfont-xsmall"} -->
<p class="has-text-align-center has-secondary-color has-text-color has-superbfont-xsmall-font-size">Ella is a dedicated food explorer with a palate for adventure. Her guides delve into the culinary world, uncovering hidden gems, street food delicacies, and dining experiences.</p>
<!-- /wp:paragraph -->
